...
import com.example.tripfair.MainActivity;
import com.example.tripfair.R;

import com.example.tripfair.ContentDTO;
...
public class DetailAdapter extends RecyclerView.Adapter<DetailAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull DetailAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.detailviewitem_favoritecounter_textview.setText(String.valueOf(contentDTOs.get(position).getFavoriteCount()));
...
//                ft.replace(R.id.detailviewfragment_recyclerview, fragment);
                ft.commit();
                            ...
                            firestore.collection("images").whereEqualTo("favorites", favori)
                                    .addSnapshotListener(new EventListener<QuerySnapshot>() {
                                        ...
                                        public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                                            if (value != null) {
                                                holder.detailviewitem_favrite_imageview.setImageResource(R.drawable.ic_baseline_favorite_border_24);
                                                holder.detailviewitem_favoritecounter_textview.setText(String.valueOf(contentDTO.getFavoriteCount()));
                                                return;
                                            }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            detailviewitem_profile_imageview_content.setBackground(drawable);
            detailviewitem_profile_imageview_content.setClipToOutline(true);
        }
